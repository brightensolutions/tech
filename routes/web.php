...
Route::group(['prefix' => '/super-admin'], function () {
    ...
    // Other admin routes
    Route::get('dashboard', [Admin_Controller::class, 'showdashboard']);
    Route::get('openings', [Admin_Controller::class, 'openings']);
    Route::get('add-openings', [Admin_Controller::class, 'addopenings']);
    Route::post('added-openings', [Admin_Controller::class, 'addedopenings'])->name('addedopening');
