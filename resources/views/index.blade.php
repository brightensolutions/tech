...
<head>
    ...
    <style>
        .center-container {
          ...
          align-items: center;
         /* Optional: Adjust this according to your layout */
        }

        .btn {
          text-decoration: none;
          padding: 10px 20px;
          background-color: #6568d9;
          color: white;
          border-radius: 5px;
        }
    ...
    .shape-right {
        ...
        -webkit-clip-path: polygon(100% 0%, 100% 96%, 25% 35%);
        clip-path: polygon(100% 0%, 100% 96%, 30% 25%);
...
<body>
    ...
    <main class="fix">
                        ...
                        <div class="col-lg-8">
                            <div class="banner-col-1">
                                <div class="section-title mb-50 tg-heading-subheading animation-style3">
                                    <!-- <span class="sub-title">Best accounting Services</span> -->
                                    <h2 class="title tg-element-title text-60-bold" style="perspective: 400px;">
                                        <div class="split-line" style="display: block; text-align: start; position: relative;">
                                            <div style="position:relative;display:inline-block;">
                                                <div style="position: relative; display: inline-block; opacity: 1; transform: translate(0px, 0px);">
                                                    We are the growth partner to tech companies
                                                </div>
                                            </div>
                                        </div>
                                    </h2>
                                </div>
                                <p>We help your company grow with tech recruitment and IT consultancy services tailored to your needs.</p>
                                <p>Our consultants are some of the best Tech Recruiters and Software Engineers in Sweden.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- <div class="banner-col-2">
                    <div class="swiper-container slider_baner__active slider_baner_home6 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                        <div class="swiper-wrapper" id="swiper-wrapper-9fb6f5dad7dbd7c6" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-1486px, 0px, 0px);">
                            <div class="swiper-slide slide__home7 swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="0" role="group" aria-label="1 / 3" style="width: 743px;">
                                <img src="assets/img/home7/banner.png">
                            </div>
                            <div class="swiper-slide slide__home7 swiper-slide-duplicate-active swiper-slide-prev swiper-slide-duplicate-next" data-swiper-slide-index="0" role="group" aria-label="2 / 3" style="width: 743px;">
                                <img src="assets/img/home7/banner.png">
                            </div>
                            <div class="swiper-slide slide__home7 swiper-slide-duplicate swiper-slide-active swiper-slide-duplicate-prev" data-swiper-slide-index="0" role="group" aria-label="3 / 3" style="width: 743px;">
                                <img src="assets/img/home7/banner.png">
                            </div>
                        ...
                        <div class="box-button-slider-bottom">
                            <div class="testimonial__nav-four">
                                <div class="testimonial-two-button-prev button-swiper-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-9b110a98b9a1019db"><i class="flaticon-right-arrow"></i></div>
                                <div class="testimonial-two-button-next button-swiper-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-9b110a98b9a1019db"><i class="flaticon-right-arrow"></i></div>
                            </div>
                        </div>
                    </div>
                </div> -->
            </div>
            <div class="services__item-wrap-two" style="margin:0px 60px 20px 60px">
                <div class="row justify-content-center gutter-24">
                                ...
                                <div class="services__icon-shape">
                                    ...
                                    <div class="shape two">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8" fill="none">
                                            <path d="M7.36755 4.37738C7.36755 6.02099 6.03514 7.3534 4.39153 7.3534C2.74792 7.3534 1.41552 6.02099 1.41552 4.37738C1.41552 2.73376 2.74792 1.40136 4.39153 1.40136C6.03514 1.40136 7.36755 2.73376 7.36755 4.37738Z" stroke="currentcolor" stroke-width="1.19041"></path>
                                        </svg>
                                    </div>
                                    <div class="shape three rotateme">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9" fill="none">
                                            <path d="M1.70898 1.73877L7.06581 7.0956M1.70898 7.0956L7.06581 1.73877" stroke="currentcolor" stroke-width="1.92846" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                    </div>
                                </div>
                            </div> -->
                            <div class="services__content-five">
                                <h2 class="title"><a href="/services-details">IT Consultancy</a></h2>
                                <p style="font-size:17px;">We are all challenged to keep pace with today’s fast-moving IT landscape. If you need to increase the workforce in your IT team, we will provide you with some of the best IT experts who are ready to tackle your projects with a custom solution.</p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__item-five">
                            ...
                            <div class="services__content-five">
                                <h2 class="title"><a href="/services-details">IT Recruitment</a></h2>
                                <p style="font-size:17px;">We work hand in hand with your company to help you succeed with your IT/Tech Recruitment. We are able to move the processes forward in the best way and act as first-line support for all your hiring needs.</p>
                                <a class="btn" href="/services-details">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__item-five">
                            ...
                            <div class="services__content-five">
                                <h2 class="title"><a href="/services-details">Payroll Company</a></h2>
                                <p style="font-size:17px;">Non-Swedish consultancy companies often have
                                    assignment and matching candidates. But they can’t pay the candidate in Sweden directly.They need an umbrella company in Sweden for it. And we help the companies with it.
                                </p>
                                <a class="btn" href="/services-details">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__item-five">
                            ...
                            <div class="services__content-five">
                                <h2 class="title"><a href="/services-details">IT Services</a></h2>
                                <p style="font-size:17px;">We are premier IT service provider, delivering cutting-edge solutions tailored to your needs. With a focus on innovation and reliability, we empower businesses to thrive in the digital age.</p>
                                <a class="btn" href="/services-details">Read More</a>
                            </div>
                        </div>
                    </div>
        ...
        <section class="about__area-eight">
            <div class="container">
         ...
         <div class="brand-area brand__area-seven brand__area-home7">
            <div class="container">
                <div class="section-title mb-50">
                                    <h2 class="title wow">Some of our clients</span></h2>
                                </div>
                ...
                <div class="row justify-content-center">
                    <!-- <div class="col-lg-7">
                        <div class="section-title text-center mb-50">
                            ...
                            <h2 class="title">Expert Financial and Accounting<br class="d-none d-lg-block" /> Services for Businesses</h2>
                        </div>
                    </div> -->
                </div>
                <div class="row justify-content-center gutter-24 services__item-style-2">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="services__item-five">
                            ...
                            <div class="services__content-five">
                                <h2 class="title"><a href=''>Tech Recruitment service</a></h2>
                                <p>Our dedicated team of tech recruitment consultants works closely with clients, offering personalized support to help them succeed in their IT recruitment.

We leverage their in-depth knowledge and industry insights to streamline the recruitment process, saving valuable time and resources for our clients.

Embedded Recruitment Consultant: our Tech Recruiter works closely with your company to ensure your success in Tech Recruitment.</p><a class='btn' href='services-details.html'>Read More</a>
                            </div>
                        </div>
                    </div>
...
Those experts come from diverse backgrounds worldwide, leveraging their global experience and expertise to serve the Nordics. Their strength lies in their diversity and progressive mindset, which are vital assets in an industry that continually demands more from IT engineers. Comprising software engineering experts hailing from various corners of the globe, our team brings a rich tapestry of unique skills and knowledge to the table. This enables us to offer a comprehensive range of IT consulting services, spanning tech leadership, architecture design, development, and implementation. Irrespective of your business goals, our team is dedicated to helping you achieve them through the effective utilization of technology. We invest time in understanding your specific needs and challenges, tailoring our services to deliver optimal solutions. Whether you require assistance with an ongoing project or seek an end-to-end solution, our experienced team possesses the requisite knowledge and expertise to ensure successful outcomes. Our IT consultants have a proven track record of successfully supporting renowned clients such as Spotify, Klarna, Tele2, and SEB on demanding projects that demanded innovative and pioneering approaches.</p>
        ...
        <!-- slider-area-end -->
        <!-- brand-area -->
        <section class="journey_area-seven">
            <div class="container">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-12 col-lg-12">
                            <div class="section-title tg-heading-subheading animation-style3">
                                ...
                                <h2 class="title tg-element-title mb-25">We get you on top of the game in acquiring difficult-to-find talent. </h2>
                                <p class="mb-25">Don't let talent acquisition be a barrier to your company's growth. Partner with Tech Stack and unlock access to the best and brightest talent in the industry. Get in touch with us today to learn more about how we can help you reach your recruitment goals.</p>
                                <!-- <a class='btn' data-aos-delay='600' data-aos='fade-up' href=''>See All Services</a> -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-9">
                        <div class="choose__img-wrap-home7">
                            <div class="main-img-why">
                                <img src="assets/img/home7/img-1.png" alt="TechStack">
                    ...
                    <div class="col-lg-6">
                        <div class="choose__content-three">
                            ...
                            <h1>We are a fun-loving team with an agile mindset.
                                Our work is guided by the core belief that the best results are gained through mutual respect and honesty.</h1>
        ...
        <!-- <section class="services-area services-bg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title text-center mb-40 tg-heading-subheading animation-style3">
                            <span class="sub-title">Features Projects</span>
                            <h2 class="title tg-element-title">Transforming Businesses with Financial Excellence</h2>
                        </div>
                    </div>
                </div>
                <div class="services-item-wrap">
                    <div class="row justify-content-center">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a class='shine-animate' href='services-details.html'><img src="assets/img/services/services_img01.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a class='shine-animate' href='services-details.html'><img src="assets/img/services/services_img02.jpg" alt=""></a>
                                </div>
                                <div class="services-content">
                                    <div class="icon">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a class='shine-animate' href='services-details.html'><img src="assets/img/services/services_img03.jpg" alt=""></a>
                                </div>
                                <div class="services-content">
                                    <div class="icon">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a class='shine-animate' href='services-details.html'><img src="assets/img/services/services_img04.jpg" alt=""></a>
                                </div>
                                <div class="services-content">
                                    <div class="icon">
                                        <i class="flaticon-light-bulb"></i>
                ...
                <div class="services-bottom-content">
                    <a class='btn btn-two' href='services.html'>See All Services</a>
                    <a class='link-gray' href='contact.html'>Contact Us for a Quote</a>
                </div>
            </div>
        </section> -->
        <!-- services-area-end -->
        ...
        <!-- end our journey -->
        <!-- Testimonials -->
        <section class="testimonials_area-seven">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title text-center mt-40 mb-40 tg-heading-subheading animation-style3">

                            <h2 class="title tg-element-title">What are They Saying<br class="d-none d-lg-block"> About Our Company</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-slide slide__home7">
                                <div class="item-testimonial">
                                    ...
                                    <div class="item-testimonial-right">
                                        <p>Our experience with this company has been exceptional. Their financial and accounting services have greatly improved our business operations. Lorem ipsum dolor sit amet, adipiscing elit. Duis consectetur auctor elit vehicula onec conse tetur risus dignissim justo faubus pretium.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide slide__home7">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-10">
                        <div class="blog-post-item blog__post-three shine-animate-item">
                            <div class="blog-post-thumb blog__post-thumb-three">
                                <a class='shine-animate' href=''><img src="assets/img/blog/blog_post01.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content blog__post-content-three">
                                <a class='post-tag' href=''>IT</a>
                                <h2 class="title"><a href=''>IT Consultancy</a></h2>
                                <div class="blog-post-meta mb-20">
                                    <ul class="list-wrap">
                                        <li><i class="fas fa-calendar-alt"></i>April 1, 2024</li>
                                    </ul>
                                </div>
                                <a class='btn' href=''>Continue Reading</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-10">
                        <div class="blog-post-item blog__post-three shine-animate-item">
                            <div class="blog-post-thumb blog__post-thumb-three">
                                <a class='shine-animate' href=''><img src="assets/img/blog/blog_post02.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content blog__post-content-three">
                                <a class='post-tag' href=''>IT</a>
                                <h2 class="title"><a href=''>IT Consultancy</a></h2>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-10">
                        <div class="blog-post-item blog__post-three shine-animate-item">
                            <div class="blog-post-thumb blog__post-thumb-three">
                                <a class='shine-animate' href=''><img src="assets/img/blog/blog_post03.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content blog__post-content-three">
                                <a class='post-tag' href=''>IT</a>
                                <h2 class="title"><a href=''>IT Recruitment</a></h2>
                                <div class="blog-post-meta mb-20">
                                    <ul class="list-wrap">
                                        <li><i class="fas fa-calendar-alt"></i>April 1, 2024</li>
                                    </ul>
