                        ...
                        <tbody>
                           ...
                           @foreach ($data as $item)
                              <tr>
                                 ...
                                 <td> <a onclick="return confirm('Are you sure?')" href="/super-admin/delete-appointment/{{ $item->id }}"><i class="fa fa-trash" style="padding:5px;font-size:15px;cursor:pointer;"
