    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <!-- left column -->
                <div class="col-md-6">
                    <a href="/super-admin/subcategory">Go Back</a>
                    &nbsp;
                    <a href="/super-admin/add-subcategory">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" id="subcategory" action="{{ route('addedsubcategory') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input type="hidden" name="old_subcategory" value="{{ $data->subcategory ?? '' }}">
                                <div class="card-body">
                                    ...
                                    <select class="form-control" name="category" id="categorySelect">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ isset($data) && $data->category == $category->cat_id ? 'selected' : '' }}>
                                                {{ $category->cat_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $data->subcategory ?? '' }}" name="subcategory" id="textInput">
