...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit International Journey Images</h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/">Update international images</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" id="journeyimage" action="{{ route('internationaljourney') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <img id="imagePreview"
                                        src="{{ asset('assets/images/journy-images/' . $data->img) }}" alt="About Image"
