                        ...
                        <tbody>
                           ...
                           @foreach ($data as $item)
                              <tr>
                                 ...
                                 <td>{{ $item->review}}</td>
                                 <td>
                                    <a href="/super-admin/edit-testimonial/{{ $item->id }}"><i class="fa fa-edit" style="padding:5px;font-size:15px;cursor:pointer;"
                                          aria-hidden="true"></i></a>
                                    <a onclick="return confirm('Are you sure?')" href="/super-admin/delete-testimonial/{{ $item->id }}"><i class="fa fa-trash" style="padding:5px;font-size:15px;cursor:pointer;"
                                          aria-hidden="true"></i></a>
                                 </td>
                              </tr>
                              @php
