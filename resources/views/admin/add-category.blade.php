    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <!-- left column -->
                <div class="col-md-6">
                    <a href="/super-admin/category">Go Back</a>
                    &nbsp;
                    <a href="/super-admin/add-category">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" id="category" action="{{ route('addedcategory') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $data->category ?? '' }}" name="category" id="textInput">
