...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add International Journey Images</h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/">Add international Journeyimages</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <!-- left column -->
                <div class="col-md-6">
                    <a href="/super-admin/international-journey">Go Back</a>
&nbsp;
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" id="journeyimage" action="{{ route('addedinternationaljourney') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <img id="imagePreview" src="{{ asset('assets/images/journy-images/' . ($data->img ?? '')) }}" alt="About Image" style="width: 30%; height: 30%; display: none;">
...
<script>
    $(document).ready(function() {
        ...
        $('#journeyimage').submit(function(e) {
            e.preventDefault();

            var formData = new FormData(this);
            var url = $(this).attr('action');
            var method = $(this).find('input[name="journey_id"]').val() ? 'PUT' : 'POST';
